...
<BlockTitle text="Общие сведения о магазине"/>

{#if false}
  <div class="block">
    <div class="logo">
      <DefaultLogo width={98} height={98}/>
      <p>Добавить логотип магазина</p>
    </div>
  </div>
{/if}
...
<div style="margin-top: 20px">
  <Button text="Сохранить изменения" on:click={handleSave}/>
</div>